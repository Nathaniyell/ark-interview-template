                  ...
                  <tbody>
                    {topProducts.map((product) => (
                      <tr key={product.id} className="">
                        ...
                        <td className="text-right py-[14px] text-sm font-[200] text-white/60">
                          {product.price}
                          <div className="h-[1px] bg-[#bfbfbf]/25 mt-[26px]"></div>
                        </td>

                        <td className="text-right py-[14px] text-sm font-[200] text-white/60 relative">            
                          {product.revenue}                      
                          <div className="h-[1px] bg-[#bfbfbf]/25 mt-[26px]"></div>
                        </td>
                        <td className="text-right py-[14px] text-sm font-[200] text-white/60 pr-[19px]">
                          {product.orders}
                          <div className="h-[1px] bg-[#bfbfbf]/25 mt-[26px]"></div>
                        </td>
                      </tr>
                  ...
                  <tbody>
                    {locationMetrics.map((location) => (
                      <tr key={location.country} className="">
                        <td className="py-3 pl-[19px] text-sm font-[200] text-white/60 uppercase">
                          {location.country}
                          <div className="h-[1px] bg-[#bfbfbf]/25 mt-2"></div>
                        </td>
                        <td className="text-right py-3 text-sm font-[200] text-white/60">
                          {location.revenue}
                          <div className="h-[1px] bg-[#bfbfbf]/25 mt-2"></div>
                        </td>
                        <td className="text-right py-3 pr-[19px] text-sm font-[200] text-white/60">
                          {location.orders}
                          <div className="h-[1px] bg-[#bfbfbf]/25 mt-2"></div>
                        </td>
                      </tr>
